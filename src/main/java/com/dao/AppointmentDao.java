...
public class AppointmentDao {
	...
	public Appointment getAppointmentById(int id) {
		...
		try {
			...
			String sql = "select * from appointment where id_app=?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setInt(1, id);
	...
	public boolean updateCommentStatus(int id, int doctId, String status) {
		boolean f = false;
		try {
			String sql = "update appointment set status=? where id_app=? and doctor_id=?";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public List<Appointment> getAllAppointment() {
		...
		try {
			...
			String sql = "select * from appointment order by id_app desc";
			PreparedStatement ps = conn.prepareStatement(sql);
